...
impl DebugServer {
    #[tool(
        name = "debug_launch",
        description = "Start a debugging session by launching a program under a debug adapter"
    )]
    ...
    #[tool(
        ...
        description = "Set a breakpoint at a file and line, with optional condition"
    )]
    ...
    #[tool(
        ...
        description = "Remove a breakpoint at a file and line"
    )]
    ...
    #[tool(
        name = "debug_continue",
        description = "Resume execution until the next breakpoint or process exit"
    )]
    ...
    #[tool(
        name = "debug_step",
        description = "Step in, out, or over the current line"
    )]
    async fn debug_step(
        &self,
    ...
    #[tool(
        ...
        description = "Get the current call stack with surrounding source code context"
    )]
    ...
    #[tool(
        name = "debug_evaluate",
        description = "Evaluate an expression or read a variable in the current debug frame"
    )]
    ...
    #[tool(
        name = "debug_pause",
        description = "Pause execution of one or all threads"
    )]
    ...
    #[tool(
        name = "debug_get_page",
        description = "Fetch the next page of a truncated debug result using a pagination token"
    )]
    ...
    #[tool(
        ...
        description = "End the debug session, terminate the debuggee, and clean up"
    )]
